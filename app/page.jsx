          ...
          {messages.length === 0 ? (
            <div className="relative z-10">
              ...
              <div className="flex flex-col items-center justify-center mb-8 fade-in">
                {/* Logo dengan ukuran dan styling */}
                ...
                {/* Teks di bawah logo */}
                <div className="glass-morphism px-6 py-3 rounded-2xl mb-4 glow-effect-hover">
              ...
              <div className="text-center max-w-3xl px-4">
                <div className="flex items-center justify-center gap-3 mb-6 fade-in-delay-1">
                  <div className="glass-morphism-strong px-8 py-6 rounded-3xl shadow-2xl">
                ...
                <div className="fade-in-delay-2">
                  <div className="glass-morphism px-6 py-4 rounded-2xl inline-block glow-effect-hover">
                ...
                {/* Decorative Elements */}
                <div className="mt-12 flex justify-center gap-4 fade-in-delay-2">
                  <div className="glass-morphism px-4 py-2 rounded-xl hover-lift cursor-pointer">
            ...
            > 
              {selectedChat && (
                <div className="fixed top-8 glass-morphism-strong py-2 px-4 rounded-xl font-semibold mb-6 glow-effect z-20 hover-lift">
